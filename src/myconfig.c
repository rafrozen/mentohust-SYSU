...
#endif
static const char *CFG_FILE = "/etc/mentohust-sysu-triple.conf";	/* 配置文件 */
static const char *LOG_FILE = "/tmp/mentohust-sysu-triple.log";	/* 日志文件 */
static const char *LOCK_FILE = "/var/run/mentohust-sysu-triple.pid";	/* 锁文件 */
...
void initConfig(int argc, char **argv)
{
	...
	printf(_("\n欢迎使用MentoHUST SYSU Triple版\t版本: %s\n"
